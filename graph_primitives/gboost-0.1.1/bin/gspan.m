function [subg, count, GY, indices, node_indices] = gspan (G, minsup, size_req, ...
...
if nargin < 2 || nargin > 10 || nargout > 5
...
if nargin > 3
	...
	if nargout == 5
		[subg, count, GY, indices, node_indices] = mexgspan (G, minsup, d_size_req, 0);
    elseif nargout == 4
		[subg, count, GY, indices] = mexgspan (G, minsup, d_size_req, 0);
    elseif nargout == 3
		[subg, count, GY] = mexgspan (G, minsup, d_size_req, 0);
	elseif nargout == 2
		[subg, count] = mexgspan (G, minsup, d_size_req, 0);
